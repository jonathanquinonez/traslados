...
var configRevenue = {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [randomScalingFactor(200), randomScalingFactor(200), randomScalingFactor(200), randomScalingFactor(200), randomScalingFactor(200), randomScalingFactor(200), randomScalingFactor(200)],
            fill: true
        }]
    },
    options: {
...
var configTrafficAudiance = {
    ...
    data: {
        datasets: [{
            ...
            backgroundColor: [window.chartColors.successcolorlight, window.chartColors.errorcolorlight, window.chartColors.warningcolorlight, window.chartColors.infocolorlight],
            label: 'Percentage'
        }],
        labels: ["Google", "CodigoForge", "Themeforest", "Referal"]
    },
    options: {
        responsive: true,
        legend: {
...
var configProductType = {
    ...
    data: {
        datasets: [{
            ...
            backgroundColor: [window.chartColors.primarylight, window.chartColors.secondarylight, window.chartColors.warningcolorlight],
            label: 'Dataset 1'
        }],
        labels: ["HTML Template", "VueJS", "Laravel"]
    },
    options: {
        responsive: true,
        legend: {
    ...
    $(window).on('load', function () {
        setTimeout(function () {
            ...
            Materialize.toast($toastContent, 4000, '', function () {
                Materialize.toast($navInfo, 5000, 'rounded');
            });
        }, 2011);
    });
})();