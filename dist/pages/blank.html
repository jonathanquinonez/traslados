      ...
      <div class="vertical-navigations animated">
        <ul class="side-nav fixed animated collapsible collapsible-accordion" id="nav-default">
          ...
          <li><a class="collapsible-header waves-effect waves-set" href="#"><i class="material-icons">person</i><span>Users</span><i class="material-icons mdi-navigation-chevron-left">keyboard_arrow_left</i></a>
            <div class="collapsible-body">
              <ul>
                <li class="menu-item"><a class="waves-effect waves-set" href="user-profile.html"><span>User Profile</span></a></li>
                <li class="menu-item"><a class="waves-effect waves-set" href="user-cards.html"><span>Profile Cards</span></a></li>
              </ul>
            </div>
          </li>
          <li><a class="collapsible-header waves-effect waves-set active current" href="#"><i class="material-icons">pages</i><span>Extra</span><i class="material-icons mdi-navigation-chevron-left open-aside">keyboard_arrow_left</i></a>
            <div class="collapsible-body">
              <ul>
